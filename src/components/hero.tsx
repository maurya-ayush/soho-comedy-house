      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-12 sm:py-0">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-primary dark:border-primary text-primary dark:text-primary hover:text-primary hover:bg-neutral-600 dark:hover:bg-primary/10 text-base sm:text-lg px-8 bg-neutral-600"
            onClick={() => {
